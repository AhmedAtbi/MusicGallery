		...
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				...
				<div class="form-group">
					<div class="form-group">
						<label>Artiste :</label> <label>${artiste.nom}</label>
					</div>
					...
					<div class="form-group">
						<img src="${artiste.image}" align="top" width="300" height="200">
					</div>
					...
					<table class="table table-striped">
						...
						%>
							...
							%>
								...
								<td><a href="CategorieDetails.php?id=${album.categorie}"><%=nom_categorie%></a></td>
